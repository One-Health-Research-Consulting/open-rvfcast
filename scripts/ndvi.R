...
# from open search
url <- "https://catalogue.dataspace.copernicus.eu/resto/api/collections/Sentinel3/search.json?maxRecords=100&productType=SY_2_V10___"
resp <- GET(url)
out <- fromJSON(rawToChar(resp$content))
out$features$properties$title
