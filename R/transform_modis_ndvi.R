...
#' @param basename_template Template for the filename of the saved MODIS NDVI data. Default is "transformed_modis_NDVI_{start_date}.parquet".
...
transform_modis_ndvi <- function(modis_ndvi_token,
  ...
  response <- httr::GET(
    paste("https://appeears.earthdatacloud.nasa.gov/api/bundle/", task_id, "/", file_id, sep = ""),
  ...
  transformed_raster <- transform_raster(
