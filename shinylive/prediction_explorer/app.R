...
## Shinylive version: no server-side I/O, data bundled with app
####
...
map_dat          <- readRDS("app_data_processed.Rds")
...
, tags$head(
    ## Load IBM Plex fonts directly from Google CDN (no server-side curl needed)
...
, tabPanel(
    title = "User Guide"
  , tags$iframe(
      src   = "prediction_explorer_guide.html"
